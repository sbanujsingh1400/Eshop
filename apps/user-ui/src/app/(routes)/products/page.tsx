...
const page = () => {
    ...
    const updateURL= ()=>{
        ...
        router.replace(`/products?${decodeURIComponent(params.toString())}`, { scroll: false });
    }
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12' >
            ...
            <div className="w-full flex flex-col lg:flex-row gap-8">
                ...
                <aside className='w-full lg:w-72 lg:flex-shrink-0 h-max bg-white p-6 rounded-2xl shadow-xl shadow-slate-200/50 space-y-6' >
                    ...
                    {/* Sizes */}
                    <div>
                      <h3 className='text-lg font-semibold text-slate-800 border-t border-slate-200 pt-6' >Filter By Sizes</h3>
                      <ul className="space-y-3 pt-4">
                        {sizes.map((size) => (
                ...
                {/* product grid */}
                 <div className="flex-1">
                   {isProductLoading? (
                    ...
                    <p className="w-full text-center py-20 text-slate-500 bg-white rounded-lg shadow-md">No Products found matching your criteria!</p>
                  ))}
