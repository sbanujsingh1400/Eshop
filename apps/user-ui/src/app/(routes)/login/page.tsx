...
const page = () => {
    ...
    <div className='w-full min-h-[80ch] bg-slate-50 flex flex-col items-center justify-center p-4' >
       ...
       <div className='w-full flex justify-center' >
        ...
        <h3 className='text-2xl font-bold text-center text-slate-900' >Login to Eshop</h3>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
         ...
         {/* Password */}
            ...
            <button disabled={loginMutation.isPending}  className='w-full font-semibold bg-slate-900 text-white py-3 rounded-lg hover:bg-slate-800 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-900 disabled:opacity-50 disabled:cursor-not-allowed' >
